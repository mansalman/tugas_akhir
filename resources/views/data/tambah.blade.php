...
<div class=container>
    <form action='/data/simpan' method="post" class="row g-2">
        @csrf
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control @error('nama_santri') is-invalid @enderror"
                        name="nama_santri" value="{{ old('nama_santri') }}" id="nama_santri">
                    @error('nama_santri')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
