...
<div class=container>
    <form action='/variabel/simpan' method="post" class="row g-2">
        @csrf
        <div class="my -3 p-3 bg-body rounded shadow-sm">
            <div class="mb-3 row">
                <label for="kode_variabel" class="col-sm-2 col-form-label">Kode Variabel</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control @error('kode_variabel') is-invalid @enderror"
                        name="kode_variabel" value="{{ old('kode_variabel') }}" id="kode_variabel">
                    @error('kode_variabel')
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control @error('nama_variabel') is-invalid @enderror"
                        name="nama_variabel" value="{{ old('nama_variabel') }}" id="nama_variabel">
                    @error('nama_variabel')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
